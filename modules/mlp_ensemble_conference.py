...
class MLPEnsemble(BaseEstimator, ClassifierMixin):
    ...
    def __init__(self, configurations=None, epochs=1000, batch_size=32, verbose=0):
        """
        Initialize with 2 specific MLP configurations
        Config 1: 2 hidden layers with 64 neurons each + Dropout
        Config 2: 3 hidden layers with 96 neurons each + Dropout 
        """
